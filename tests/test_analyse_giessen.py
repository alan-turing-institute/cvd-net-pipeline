...
def test_analyse_giessen_valid_input(cleanup_output_file):
    ...
    expected_output = pd.read_csv('tests/expected_outputs/analyse_giessen_module/output_64_9_params/synthetic_data/waveform_resampled_all_pressure_traces_rv.csv')
