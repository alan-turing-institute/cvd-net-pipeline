...
def cleanup_output_file():
    output_file = "tests/inputs_for_tests/analyse_giessen_module/output_50_9params/waveform_resampled_all_pressure_traces_rv.csv"
    yield output_file
...
def test_analyse_giessen_valid_input(cleanup_output_file):
    ...
    analyse_giessen('tests/inputs_for_tests/analyse_giessen_module/output_50_9params')

    # Check if the output data matches the expected output
    output_data = pd.read_csv(cleanup_output_file)
    expected_output = pd.read_csv('tests/expected_outputs/analyse_giessen_module/output_50_9params/waveform_resampled_all_pressure_traces_rv.csv')
